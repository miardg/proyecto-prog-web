...
if (!Permisos::tienePermiso("Ver plan actual", $idUsuario)) {
    echo "<div class='alert alert-danger text-center mt-5'>No tenés permiso para ver tu plan actual</div>";
    exit;
}
?>
<!DOCTYPE html>
...
<body>
    ...
    <div class="d-flex justify-content-center align-items-start min-vh-100 bg-light pt-5">
        <div class="card shadow-lg p-4" style="max-width: 900px; width: 100%;">
            <h2 class="titulo-panel mb-4 text-center">Mi plan actual</h2>
            <div id="miPlan"></div>
        </div>
    </div>
</body>
