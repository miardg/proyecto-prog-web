                    ...
                    <div class="auth-card">
                        <div class="row g-0">
                            ...
                            <div class="col-md-6 p-5">
                                ...
                                <form id="crearClaseForm" novalidate>
                                    <div class="mb-3">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="tipo_actividad"
                                            name="tipo_actividad" required pattern="^[a-zA-ZÀ-ÿ\s]{2,50}$">
                                    ...
                                    <div id="claseFeedback" class="mt-2"></div>

                                    <button type="submit" class="btn btn-warning w-100 mb-3" id="btnCrearClase">
                                        Crear Clase
                                    </button>
                                </form>
                            </div>
