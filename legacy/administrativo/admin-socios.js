...
let users = [
  { id: 1, name: "Juan Pérez", email: "juan@mail.com", tel: "11-1234-4567", plan: "Plan Premium", password: "123456" },
  { id: 2, name: "María Gómez", email: "maria@mail.com", tel: "11-1234-4567", plan: "Plan Básico", password: "abcdef" },
  { id: 3, name: "Carlos Ruiz", email: "carlos@mail.com", tel: "11-1234-4567", plan: "Plan Completo", password: "qwerty" },
];
...
const userPlanInput = document.getElementById("userRole");
...
function openEditUserModal(user) {
  ...
  userTelInput.value = user.tel;
  userPlanInput.value = user.role;
...
function validateUserForm() {
  ...
  if (userTelInput.value.trim().length < 3) {
    userTelInput.classList.add("is-invalid");
    valid = false;
  } else userTelInput.classList.remove("is-invalid");

  
  if (!userPlanInput.value) {
    userPlanInput.classList.add("is-invalid");
    valid = false;
  } else userPlanInput.classList.remove("is-invalid");
...
userForm.addEventListener("submit", (e) => {
  ...
  const userData = {
	...
	tel: userTelInput.value.trim(),
    role: userPlanInput.value,
